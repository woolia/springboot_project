...
public class QItem extends EntityPathBase<Item> {
    ...
    private static final long serialVersionUID = -1780836442L;

    public static final QItem item = new QItem("item");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final EnumPath<project.pr.domain.status.ItemType> itemType = createEnum("itemType", project.pr.domain.status.ItemType.class);
