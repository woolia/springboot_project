...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 634125595L;
    ...
    public final StringPath parcelType = createString("parcelType");

    public final EnumPath<project.pr.domain.status.OrderStatus> status = createEnum("status", project.pr.domain.status.OrderStatus.class);
